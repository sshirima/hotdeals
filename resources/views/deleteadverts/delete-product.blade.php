...
@section('content')
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-8">
                {{ Form::open(['method' => 'DELETE', 'route' => ['product-advert.remove', $advert->id]]) }}
                <p>
                ...
                <a href="{{route('seller.product-advert.show', $advert->id)}} " class="btn btn-default">
                    Cancel
                </a>
                {{ Form::close() }}
            </div>
