...
<div class="form-group col-md-6">
    ...
    <select class="form-control chosen-select" id="regions" name="region_id" data-placeholder="Choose a Region...">
        @if (!empty($advert))
...
<div class="form-group col-md-6">
    {!! Form::label('subcategory', 'Choose subcategories') !!}
    <div id="subcategory"></div>
    <select class="form-control  chosen-select" name="subcat_id[]" multiple data-placeholder="Choose subcategory...">
